...
do
        python main.py darkflpg         $3  --sw static     --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset cifar100_noniid$noniid --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs --slimmable --slim_ratios $slim_ratios --slim_ce --slim_kd 
        python main.py darkflpa2        $3  --s_gamma 0.99  --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset cifar100_noniid$noniid --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs --slimmable --slim_ratios $slim_ratios --slim_ce --slim_kd 
