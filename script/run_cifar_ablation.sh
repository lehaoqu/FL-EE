...
python main.py darkflpg         $ply                   --sw $2    --ft full --suffix $1/full/noniid1/${2}_diffg/    --device $3 --dataset cifar100_noniid1 --model $md --sr $sr --total_num $total_num --lr $lr       --bs $bs 
python main.py darkflpg         $ply  --diff_generator --sw $2    --ft full --suffix $1/full/noniid1/${2}_noneg/    --device $3 --dataset cifar100_noniid1 --model $md --sr $sr --total_num $total_num --lr $lr       --bs $bs 
