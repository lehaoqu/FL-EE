...
do
        if [ "$3" != "base" ]; then
                ...
                python main.py darkflpa2        --s_gamma 0.99 $3  --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset cifar100_noniid$noniid --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs 
        fi
