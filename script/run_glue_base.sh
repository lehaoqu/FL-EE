...
do
    ...
    python main.py darkflpg         $3  --noise 32  --rnd 300 --gamma 0.998 --ft $2 --suffix $1/${2}_${3}/$ds --device $4 --dataset $ds --model $md --sr $sr --total_num $total_num --lr $lr    --bs $bs --config_path $cp 
