...
do
    ...
    if [ "$3" != "base" ]; then
        python main.py darkflpg         $3   --sw static  --ft $2 --suffix $1/${2}_${3}/$ds --device $4 --dataset $ds --model $md --sr $sr --total_num $total_num --lr $lr    --bs $bs --config_path $cp 
        # python main.py darkflpa2        $3    --ft $2 --suffix $1/${2}_${3}/$ds --device $4 --dataset $ds --model $md --sr $sr --total_num $total_num --lr $lr    --bs $bs --config_path $cp 
    fi
    ...
    # python main.py reefl            $3    --ft $2 --suffix $1/${2}_${3}/$ds --device $4 --dataset $ds --model $md --sr $sr --total_num $total_num --lr 0.005  --bs $bs --config_path $cp
