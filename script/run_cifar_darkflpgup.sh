...
python main.py darkflpgup boosted --suffix exps/1106_darkflpgup/$2 --agg after --kd_direction $2 --kd_knowledge response --kd_join last --device $1 --dataset cifar100-224-d03 --model vit --sr 0.1 --total_num 120 --lr 0.05 --s_epoches 2 --valid_gap 10 --rnd 500 --is_feature False  --loss_type ce-kd_loss --sw learn --sw_type soft
