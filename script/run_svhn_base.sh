...
python main.py darkflpg         $3 --eval_test --sw static --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset svhn --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs --s_epoches 2
