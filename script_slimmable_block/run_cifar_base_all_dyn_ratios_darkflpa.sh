...
do
        t_model_path=/home/qvlehao/FL-EE/EXPS2_inout/BASE_CIFAR_ORIGIN/full_boosted/noniid${noniid}/darkflpa2_cifar100_noniid${noniid}_vit_100c_1E_lrsgd0.05_boosted.pth
        t_config_path=/home/qvlehao/FL-EE/EXPS2_inout/BASE_CIFAR_ORIGIN/full_boosted/noniid${noniid}/darkflpa2_cifar100_noniid${noniid}_vit_100c_1E_lrsgd0.05_boosted.json
        
        # python main.py darkflpg         $3  --sw static     --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset cifar100_noniid$noniid --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs --slimmable --slim_ratios $slim_ratios --slim_ce --slim_kd --slim_block_wise --slim_logits $6 --slim_features $7
        python main.py darkflpa2        $3  --s_gamma 0.99  --ft $2 --suffix $1/${2}_${3}/noniid$noniid --device $4 --dataset cifar100_noniid$noniid --model $md --sr $sr --total_num $total_num --lr $lr --bs $bs --slimmable --slim_ratios $slim_ratios --slim_ce --slim_kd --slim_block_wise --slim_logits $6 --slim_features $7 --t_model_path $t_model_path --t_config_path $t_config_path
